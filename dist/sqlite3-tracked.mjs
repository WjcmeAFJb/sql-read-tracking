...
Module["onRuntimeInitialized"] = function onRuntimeInitialized() {
  ...
  var SQLITE_BLOB = 4;
  var SQLITE_NULL = 5;
  /* ----- cwrap bindings --------------------------------------------- */ var sqlite3_open = cwrap("sqlite3_open", "number", [ "string", "number" ]);
  ...
  var sqlite3_column_int = cwrap("sqlite3_column_int", "number", [ "number", "number" ]);
  var sqlite3_column_bytes = cwrap("sqlite3_column_bytes", "number", [ "number", "number" ]);
  var sqlite3_column_blob_ptr = cwrap("sqlite3_column_blob", "number", [ "number", "number" ]);
  var sqlite3_bind_text = cwrap("sqlite3_bind_text", "number", [ "number", "number", "string", "number", "number" ]);
  ...
  var sqlite3_bind_null = cwrap("sqlite3_bind_null", "number", [ "number", "number" ]);
  ...
  var sqlite3_bind_parameter_count = cwrap("sqlite3_bind_parameter_count", "number", [ "number" ]);
  /* Tracking bindings */ var _track_begin = cwrap("sqlite3_track_begin", "number", [ "number" ]);
  ...
  var _track_read_get = cwrap("sqlite3_track_read_get", "number", [ "number", "number", "number", "number", "number", "number", "number" ]);
  ...
  var _track_write_cols = cwrap("sqlite3_track_write_columns", "string", [ "number", "number" ]);
  ...
  var _track_dump_json = cwrap("sqlite3_track_dump_json", "string", [ "number" ]);
  /* ----- Statement class -------------------------------------------- */ function Statement(stmt, db) {
    this.stmt = stmt;
    this.db = db;
    this.pos = 1;
  }
  ...
  Statement.prototype.bindFromObject = function(obj) {
    for (var k in obj) {
      var p = k.charAt(0) === ":" || k.charAt(0) === "@" || k.charAt(0) === "$" ? k : ":" + k;
  ...
  Statement.prototype.bindValue = function(v, i) {
    ...
    if (typeof v === "bigint") {
      /* split via string for simplicity */ return sqlite3_bind_text(this.stmt, i, v.toString(), -1, -1);
    }
    if (typeof v === "string") {
  ...
  Statement.prototype.colValue = function(i) {
    ...
    switch (t) {
     ...
     case SQLITE_TEXT:
      return sqlite3_column_text(this.stmt, i);
  ...
  /* ----- Database class --------------------------------------------- */ function Database(path) {
  ...
  Database.prototype["exec"] = function(sql, params) {
    ...
    while (remain && remain.trim().length > 0) {
      ...
      var rc = ccall("sqlite3_prepare_v2", "number", [ "number", "number", "number", "number", "number" ], [ this.ptr, zSql, -1, pp, pTail ]);
      if (rc !== SQLITE_OK) {
        _free(zSql);
  ...
  /* ----- Tracking API ----------------------------------------------- */ Database.prototype["beginTracking"] = function() {
  ...
  /* ----- Export ----------------------------------------------------- */ Module["Database"] = Database;
  Module["Statement"] = Statement;
};

// end include: src/bindings/api.js
var arguments_ = [];
...
function assignWasmExports(wasmExports) {
  ...
  _sqlite3_track_write_columns = Module["_sqlite3_track_write_columns"] = wasmExports["sqlite3_track_write_columns"];
  _sqlite3_track_predicate_count = Module["_sqlite3_track_predicate_count"] = wasmExports["sqlite3_track_predicate_count"];
  _sqlite3_track_predicate_get = Module["_sqlite3_track_predicate_get"] = wasmExports["sqlite3_track_predicate_get"];
  _sqlite3_track_idxwrite_count = Module["_sqlite3_track_idxwrite_count"] = wasmExports["sqlite3_track_idxwrite_count"];
  _sqlite3_track_idxwrite_get = Module["_sqlite3_track_idxwrite_get"] = wasmExports["sqlite3_track_idxwrite_get"];
  ...
  _sqlite3_track_dump_json = Module["_sqlite3_track_dump_json"] = wasmExports["sqlite3_track_dump_json"];
